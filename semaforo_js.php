...
<body>
    ...
    <?php if (isset($_GET['localidad'])) : ?>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12"><a href="phpspreadsheet_semaforo.php?localidad=<?php echo $_GET['localidad']; ?>" class="btn btn primary btn-block" role="button">Generar Reporte</a></div>
                <div class="col-12">
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            WHERE nom035_usuarios.usuarios_habilitado=1 AND final_encuesta=1 AND empleados_t_localidad = '$localidad';");
