...
?>
            <tr>
                ...
                switch ($b['seg_actividades_estatus']) {
                    case '1':
                        echo '<td style="background: #B6D7A8;color: rgb(0,0,0);">Cumplidas</td>';
                        break;
                    case '2':
                        echo '<td style="background: #9FC5F8;color: rgb(0,0,0);">En Proceso</td>';
                        break;
                    case '3':
                        echo '<td style="background: #8E7CC3;color: rgb(0,0,0);">Programada</td>';
                        break;
                    case '4':
                        echo '<td style="background: #FF2626;color: rgb(0,0,0);">Cancelada</td>';
                        break;
                    default:
                        # code...
                        break;
