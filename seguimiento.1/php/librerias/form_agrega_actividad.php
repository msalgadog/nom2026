...
$seg_planes_accion_consecutivoParam = trim((string) ($_GET['seg_planes_accion_consecutivo'] ?? ''));
...
<div class="card mt-2">
    <div class="card-body bg-light border rounded shadow">
        <form action="php/guardar/actividad.php" method="post" id="agrega_actividad">
            ...
            <input type="hidden" name="seg_actividades_plan_accion_id" value="<?php echo nom035_h($a['idseg_planes_accion']); ?>">
            ...
            <input type="hidden" name="seg_planes_accion_consecutivo" value="<?php echo nom035_h($seg_planes_accion_consecutivoParam) ?>">
            ...
            <input type="hidden" name="seg_planes_accion_cat" value="<?php echo nom035_h($a['seg_planes_accion_cat']) ?>">
            <input type="hidden" name="seg_planes_accion_dom" value="<?php echo nom035_h($a['seg_planes_accion_dom']) ?>">
            <input type="hidden" name="seg_planes_accion_acc" value="<?php echo nom035_h($a['seg_planes_accion_acc']) ?>">
            <input type="hidden" name="seg_actividades_plan_accion_id" value="<?php echo nom035_h($a['idseg_planes_accion']) ?>">
            <input type="hidden" name="seg_actividades_planes_consecutivo" value="<?php echo nom035_h($a['seg_planes_accion_consecutivo']) ?>">
            <input type="hidden" name="seg_num_consecutivo_act" value="<?php echo nom035_h($acc_nums) ?>">
                ...
                <table class="table table-striped table-hover table-bordered table-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group"><input class="form-control form-control-sm" type="date" name="seg_actividades_tipo_duedate" data-validation="required" style="display:none;"></div>
                            </td>
