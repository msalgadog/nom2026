...
if (isset($_POST['action']) && $_POST['action'] == "add_actividad") {  
    ...
    $add_act = sprintf("INSERT INTO seg_planes_accion_actividad (seg_planes_id,
    ...
    seg_actividades_estatus,seg_consecutivo) VALUES ('$seg_planes_id',
    '$seg_actividades_plan_accion_id',
    '$seg_actividades_planes_consecutivo',
    '$seg_planes_localidad',
    '$seg_planes_nempleado',
    ...
    '$seg_actividades_tipo_tiempo',
    '$seg_actividades_tipo_duedate',
    '$seg_actividades_estatus','$seg_planes_consecutivo');");
...
#http://localhost/costco2022/seguimiento/planes.php?action=addact&seg_planes_id=1&seg_consecutivo=1&seg_localidad=OFICINAS&seg_nempleado=123456&seg_planes_accion_consecutivo=3
?>
