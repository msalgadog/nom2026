            ...
            <div class="row mt-3 mb-3 mr-0 pl-0 ml-0">
                ...
                <div class="col-sm-8 col-md-8 col-lg-6 offset-lg-4 mt-2 mb-2">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a class="btn btn-success btn-sm pr-2 pl-2" role="button" style="font-size: 11px;" href="planes_admin.php<?php echo "?seg_planes_id=" . $seg_planes_id . "&seg_consecutivo=" . $seg_planes_consecutivo . "&seg_localidad=" . $seg_planes_localidad . "&seg_nempleado=" . $seg_planes_nempleado; ?>"><i class="fas fa-forward"></i> Seguimiento actividades</a></li>
                    </ul>
                </div>
                <div class="col pl-0 pr-0 mt-2"><a class="btn btn-info btn-sm pr-2 pl-2" role="button" style="font-size: 11px;" href="index.php"><i class="fas fa-backward"></i> Regresar</a></div>
            </div>
        </div>
    </section>
    <section class="pb-5">
