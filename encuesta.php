    ...
    <section class="py-5 mt-5">
        <div class="container py-4 py-xl-5">
            <div class="row">
                ...
                <div class="col-12">
                    <p class="text-justify"><strong>Hola,</strong><br><span style="color: rgb(33, 37, 41);">Esta encuesta nos ayudará a conocer cómo es el Entorno Laboral en Costco desde el punto de vista de sus empleados.</span><br><br><span style="color: rgb(33, 37, 41);">Te recordamos que éste es un proceso confidencial, ten la libertad de expresar lo que realmente sientes y piensas. Los resultados se manejarán de forma general y se usarán para fines de mejora.</span><br><br><strong><span style="color: rgb(33, 37, 41);">Recomendaciones:</span></strong><br></p>
                    <ul>
                        <li>De ser posible responde en una sola sesión; tus respuestas se guardan al terminar cada bloque de preguntas; en caso de no terminar podrás ingresar nuevamente.</li>
                        <li>Te llevará aproximadamente 10 minutos contestarla.</li>
                        <li>Lee detenidamente cada pregunta.</li>
                        <li>Elige un momento en el que estés tranquilo y sin interrupciones.</li>
                        <li>En cada bloque presiona el botón Guardar, una vez que presiones el botón no podrás regresar a la página anterior</li>
                    </ul>
                    <p><strong>Recuerda: Al terminar el Bloque 5 presiona el botón Guardar Respuestas, espera el mensaje de ¡Excelente! Gracias por contestar y presiona Continuar.</strong></p>
                    <p><span style="color: rgb(33, 37, 41);">Da click en iniciar para comenzar la encuesta NOM-035.</span><br></p>
                </div>
            </div>
            <div class="form-group" style="text-align: center;"><a class="btn btn-outline-primary btn-block btn-lg" role="button" href="nom.php?b=1">Iniciar</a></div>
        </div>
    </section>
