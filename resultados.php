...
<body style="font-family: 'Gotham Regular';">
            ...
            <div class="row">
                    ...
                    <form>
                        <div class="form-group">
                            <div class="input-group mt-2">
                                <div class="input-group-prepend"><span class="input-group-text">Avance</span></div><select class="form-control" id="distrito" name="distrito" value="0" required="">
                                    <option value="" disabled="disabled" selected="selected">Seleccione un distrito</option>
                                    <?php 
                                    if($usuarios_perfil == 1||$usuarios_perfil== 2||$usuarios_perfil== 3):
                                    ?>
                                    <option value="TODOS">TODOS</option>
                                    <?php endif;?>
                                    <?php
                                    if ($usuarios_perfil == 4||$usuarios_perfil == 5||$usuarios_perfil == 6||$usuarios_perfil == 7) {
                                        echo '<option value="' . $distrito_r . '">' . $distrito_r . '</option>';
                                    } else {
                                            ...
                                            if ($distrito_status === true) {
                                                ...
                                                if ($distrito_stmt->num_rows > 0) {
                                                    ...
                                                    while ($distrito_stmt->fetch()) {
                                                        echo '<option value="' . $empleados_distrito . '">Distrito: ' . $empleados_distrito . '</option>';
                                                    }
                                                } else {
                ...
                <div class="col-12 mt-xl-2 pl-2 pr-2">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center mt-3 mb-3"><a class="btn btn-primary mb-4 mt-4" role="button" href="reportes.php">Resultados NOM035</a>
    ...
    <?php if ($usuarios_perfil == 4||$usuarios_perfil == 5||$usuarios_perfil == 6||$usuarios_perfil == 7) : ?>
        <script>
            p4 = true;
            valor_distrito = <?php echo $distrito_r; ?>
        </script>
    <?php endif; ?>
