                            ...
                            <div role="tablist" id="accordion-2">
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-2 .item-1" href="#accordion-2 .item-1">Ambiente de trabajo </a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I2C1" style="height: 31px;" >
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br><span style="color: rgb(33, 37, 41);">Condiciones en el ambiente de trabajo</span><br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D1" style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-2 .item-2" href="#accordion-2 .item-2">Factores propios de la actividad</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I2C2" style="height: 31px;" >
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-2 .item-3" href="#accordion-2 .item-3">Organización del tiempo de trabajo</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I2C3" style="height: 31px;" >
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Jornada de trabajo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D4" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Interferencia en la relación trabajo-familia<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D5" style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-2 .item-4" href="#accordion-2 .item-4">Liderazgo y relaciones en el trabajo<br></a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I2C4" style="height: 31px;">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Liderazgo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D6"  style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Relaciones en el trabajo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D7" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Violencia<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D8" style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-2 .item-5" href="#accordion-2 .item-5">Entorno organizacional</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I2C5" style="height: 31px;">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Reconocimiento del desempeño<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D9" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Insuficiente sentido de pertenencia e inestabilidad<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I2D10" style="height: 46px;">
