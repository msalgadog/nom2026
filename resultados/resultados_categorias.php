...
<body style="font-family: 'Gotham Regular';">
                ...
                <div class="col-12 text-right pt-xl-2 pb-xl-2 pt-3 pb-3">
                    <div class="row">
                        ...
                        <div class="col-10 col-md-10 col-lg-11 text-right pt-xl-2 pb-xl-2 pt-3 pb-3 mr-0 pr-3">
                            <h1 class="p-0 m-0" style="text-align: left;font-family: 'Gotham Black';color: var(--blue);">REPORTE POR CATEGORÍAS</h1>
            ...
            <div class="row">
                <div class="col mt-lg-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Reporte por categorías</span></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col">
                            <form action="resultados_categorias.php" method="get" id="resultados_categorias" name="resultados_categorias"><input class="form-control" type="hidden" name="rp" value="1">
                                <div class="form-row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 mb-2 mt-2">
                        <a class="btn btn-primary btn-block" role="button" href="resultados_categorias_pdf.php?<?php echo nom035_h($_SERVER['QUERY_STRING'] ?? ''); ?>" target="_blank">Formato PDF</a>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-2">
                        <div class="card text-white bg-dark border-light">
                            <div class="card-header">
                                <h6 class="mb-0">Ambiente de trabajo</h6>
                            </div>
                            <div class="card-body bg-light">
                                <div id="C1"><canvas id="GC1"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="card text-white bg-dark border-light">
                            <div class="card-header">
                                <h6 class="mb-0">Factores propios de la actividad<br></h6>
                            </div>
                            <div class="card-body bg-light">
                                <div id="C2"><canvas id="GC2"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="card text-white bg-dark border-light">
                            <div class="card-header">
                                <h6 class="mb-0">Organización del tiempo de trabajo<br></h6>
                            </div>
                            <div class="card-body bg-light">
                                <div id="C3"><canvas id="GC3"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 offset-md-2 mb-2">
                        <div class="card text-white bg-dark border-light">
                            <div class="card-header">
                                <h6 class="mb-0">Liderazgo y relaciones en el trabajo<br></h6>
                            </div>
                            <div class="card-body bg-light">
                                <div id="C4"><canvas id="GC4"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="card text-white bg-dark border-light">
                            <div class="card-header">
                                <h6 class="mb-0">Entorno organizacional<br></h6>
                            </div>
                            <div class="card-body bg-light">
                                <div id="C5"><canvas id="GC5"></canvas></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php include "localidad_graficas_js/c1.php"; ?>
    <?php include "localidad_graficas_js/c2.php"; ?>
    <?php include "localidad_graficas_js/c3.php"; ?>
    <?php include "localidad_graficas_js/c4.php"; ?>
    <?php include "localidad_graficas_js/c5.php"; ?>
</body>
