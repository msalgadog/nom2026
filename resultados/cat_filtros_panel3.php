...
$f3Param = trim((string) ($_GET['f3'] ?? ''));
?>
                        <h6 class="mb-0"><?php echo nom035_h($rcompParam).":" . nom035_h($f3Param); ?></h6>
                        </div>
                        <div class="card-body bg-light" style="padding: 5px;">
                            <div role="tablist" id="accordion-3">
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-3 .item-1" href="#accordion-3 .item-1">Ambiente de trabajo</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I3C1" style="height: 31px;" >
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br><span style="color: rgb(33, 37, 41);">Condiciones en el ambiente de trabajo</span><br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D1" style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-3 .item-2" href="#accordion-3 .item-2">Factores propios de la actividad</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I3C2" style="height: 31px;">
                                            <div class="progress-bar text-dark text-dark" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo C("C2",$C2,"RESULTADO"); ?>%;background-color:<?php echo C("C2",$C2,"COLOR"); ?>"><?php echo C("C2",$C2,"MENSAJE"); ?></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-3 .item-3" href="#accordion-3 .item-3">Organización del tiempo de trabajo</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I3C3" style="height: 31px;" >
                                        <div class="progress-bar text-dark text-dark" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo C("C3",$C3,"RESULTADO"); ?>%;background-color:<?php echo C("C3",$C3,"COLOR"); ?>"><?php echo C("C3",$C3,"MENSAJE"); ?></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Jornada de trabajo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D4" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Interferencia en la relación trabajo-familia<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D5"  style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-3 .item-4" href="#accordion-3 .item-4">Liderazgo y relaciones en el trabajo<br></a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I3C4" style="height: 31px;" >
                                        <div class="progress-bar text-dark text-dark" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo C("C4",$C4,"RESULTADO"); ?>%;background-color:<?php echo C("C4",$C4,"COLOR"); ?>"><?php echo C("C4",$C4,"MENSAJE"); ?></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Liderazgo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D6"  style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Relaciones en el trabajo<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D7" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Violencia<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D8"  style="height: 46px;">
                                ...
                                <div class="card">
                                    <div class="card-header" role="tab">
                                        <h6 class="mb-0"><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-3 .item-5" href="#accordion-3 .item-5">Entorno organizacional</a></h6>
                                        <div class="progress" data-toggle="tooltip" data-bss-tooltip="" id="I3C5" style="height: 31px;" >
                                        <div class="progress-bar text-dark text-dark" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo C("C5",$C5,"RESULTADO"); ?>%;background-color:<?php echo C("C5",$C5,"COLOR"); ?>"><?php echo C("C5",$C5,"MENSAJE"); ?></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item"><span><br>Reconocimiento del desempeño<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D9" style="height: 46px;">
                                                ...
                                                <li class="list-group-item"><span><br>Insuficiente sentido de pertenencia e inestabilidad<br></span>
                                                    <div class="progress shadow" data-toggle="tooltip" data-bss-tooltip="" id="I3D10" style="height: 46px;">
