        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card"><img class="card-img-top w-100 d-block card-img-top" src="../assets/img/correobanner.png">
                        <div class="card-body">
                            <h4 class="card-title">Material de referencia&nbsp;</h4>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-dark table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>ACUSE DE LEÍDO DE LA POLÍTICA DE IDENTIFICACIÓN, ANÁLISIS Y PREVENCIÓN DE FACTORES DE RIESGOS PSICOSOCIALES</td>
                                    <td class="text-center"><a href="ACUSE_LEIDO.pdf"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cloud-download-fill text-center text-info" style="font-size: 38px;">
                                                <path fill-rule="evenodd" d="M8 0a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 4.095 0 5.555 0 7.318 0 9.366 1.708 11 3.781 11H7.5V5.5a.5.5 0 0 1 1 0V11h4.188C14.502 11 16 9.57 16 7.773c0-1.636-1.242-2.969-2.834-3.194C12.923 1.999 10.69 0 8 0zm-.354 15.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 14.293V11h-1v3.293l-2.146-2.147a.5.5 0 0 0-.708.708l3 3z"></path>
                                            </svg></td>
                                </tr>
                                <tr>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="medio_contacto" id="medio_contacto" class="form-control" data-validation="required">
                                                                <optgroup>
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            <input name="correo" id="correo" type="text" class="form-control" placeholder="Correo electrónico" data-validation="required email" style="display:none;">
                                                            <input name="telefono" id="telefono" type="tel" class="form-control" placeholder="WhatsApp / Número de teléfono móvil" data-validation="required" style="display:none;">
                                                        </div>
                                                        <div class="form-group col-md-12">
