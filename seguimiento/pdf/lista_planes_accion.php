...
<td colspan="2">
    ...
    <div>
        <table class="table table-bordered" style="width:100%;" border="1"  cellpadding="2" cellspacing="0">
            ...
            <tbody>
                <tr style="width:100%;">
                    <td style=" text-align: left;"><?php echo $a['seg_planes_accion_cat']; ?></td>
                    <td style=" text-align: left;"><?php echo $a['seg_planes_accion_dom']; ?></td>
                    <td style=" text-align: left;"><?php echo $a['seg_planes_accion_acc']; ?></td>
                </tr>
                <tr style="width:100%;">
                    <td colspan="3">
                        <h5>Actividades</h5>
                            <table class="table" style="width:100%;" border="1"  cellpadding="2" cellspacing="0"> 
                                <thead>
                                    <tr>
                                        <th style="width: 5%;">#</th>
