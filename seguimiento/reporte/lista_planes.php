<table class="table table-bordered table-sm" id="print">
            <thead>
                <tr>
                    ...
                    <th  style="width:80%;" style="text-align:left;">
                        ...
                        <li class="list-group-item text-left" style="text-align:left;"><span><strong>Fecha1:</strong></span> <?php echo $seg_fecha_atla;  ?></li>
                        </ul>
                    </th>
                </tr>
            </thead>
