...
<body style="font-family: 'Gotham Regular';">
    <nav class="navbar navbar-light navbar-expand-md fixed-top bg-white navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><img class="img-fluid"
                    data-aos="fade" src="../assets/img/seguimiento.png" width="100px"></a><button data-toggle="collapse"
                class="navbar-toggler" data-target="#navcol-3"><span class="sr-only">Toggle navigation</span><span
    ...
    <section class="mt-5 pt-5 mb-0 pb-0 mb-0 pb-0">
        <div class="container py-4 py-xl-5 mb-xl-0 pb-xl-3">
            <div class="row mt-3 mb-3 mr-0 pl-0 ml-0">
                <div class="col-12 col-sm-4 col-lg-2 text-center align-self-center pt-xl-2 pb-xl-2 pt-3 pb-3"><img
                        class="img-fluid" src="../assets/img/logo1.png"></div>
                <div class="col-sm-8 col-md-8 col-lg-6 offset-lg-4 mt-2 mb-2">
                    <ul class="list-group">
                        <li class="list-group-item"><span><strong>Localidad:</strong></span> <?php echo $localidad_r; ?>
                        </li>
                        <li class="list-group-item"><span><strong>Gerente:</strong></span>
                            <?php echo $nom_r . " " . $ap_r . " " . $apM_r; ?></li>
                        <li class="list-group-item"><span><strong>Fecha:</strong></span> <?php echo $seg_fecha_atla;  ?>
                        </li>
                        <li class="list-group-item"><a class="btn btn-success btn-sm pr-2 pl-2" role="button"
                                style="font-size: 11px;"
                                href="planes_admin.php<?php echo "?seg_planes_id=" . $seg_planes_id . "&seg_consecutivo=" . $seg_planes_consecutivo . "&seg_localidad=" . $seg_planes_localidad . "&seg_nempleado=" . $seg_planes_nempleado; ?>"><i
                                    class="fas fa-forward"></i> Seguimiento actividades</a></li>
                                    <li class="list-group-item">                                                <form id="plan1_<?php echo $a['empleados_t_localidad']; ?>" action="pdf/pdfg.php" method="POST" target="_blank">
                                                    <input type="hidden" name="sucursal" value="<?php echo $a['empleados_t_localidad']; ?>">
                                                    <input type="hidden" name="consecutivo" value="<?php echo $seg_planes_consecutivo; ?>">
                                                    <button class="btn btn-dark btn-sm d-table-cell btn-xs" type="submit" style="text-align: center;font-size: 13px;">Imprimir plan
                                                    </button>
                                                </form></li>
                ...
                <div class="col pl-0 pr-0 mt-2"><a class="btn btn-info btn-sm pr-2 pl-2" role="button"
                        style="font-size: 11px;" href="index.php"><i class="fas fa-backward"></i> Regresar</a></div>
            </div>
        </div>
    </section>
    <section class="pb-5">
    ...
    <footer data-aos="fade" class="bg-primary-gradient">
        <div class="container py-4 py-lg-5" style="margin-top: -25px;">
            <div class="row justify-content-center">
                <div
                    class="col text-center text-lg-left d-flex flex-column align-items-center align-items-lg-start item social">
                    <div class="font-weight-bold d-flex align-items-center mb-2"><span
                            class="bs-icon-md bs-icon-rounded bs-icon-primary-light d-flex justify-content-center align-items-center bs-icon mr-2"
                            data-bss-hover-animate="bounce"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
            ...
            <div class="text-muted d-flex justify-content-between pt-3" style="background: var(--bs-gray-100);">
                ...
                <ul class="list-inline mb-0">
                    <li class="list-inline-item"><a href="https://www.facebook.com/humanproconsultoria"
                    ...
                    <li class="list-inline-item"><a href="https://www.linkedin.com/company/humanpro"
                            target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
    ...
    $(document).ready(function() {
        ...
        $("#seg_actividades_tipo_duedate").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: "dd-mm-yy"
        });
        $('input[type=radio][name=seg_actividades_tipo_tiempo]').change(function() {
            ...
            if (valor == 1) {
                ...
                $("input[type=text][name=seg_actividades_tipo_duedate]").show();

            } else {
                $("input[type=hidden][name=seg_actividades_estatus]").val("2")
                $("input[type=text][name=seg_actividades_tipo_duedate]").hide();
            }
        })
        $("#categoria").change(function() {
            var categoria = $(this).val();
            var localidad = '<?php echo $localidad_r; ?>';
            $.ajax({
                type: "post",
                url: "php/funciones/cargar_dominios.php",
                data: {
                    categoria: categoria,
                    localidad: localidad
                },
        ...
        $("#dominio").change(function() {
            ...
            $.ajax({
                type: "post",
                url: "php/funciones/cargar_acciones.php",
                data: {
                    categoria: categoria,
                    localidad: localidad,
                    dominio: dominio
        ...
        $("#seg_actividades_nombre").change(function() {
            if ($(this).val() == "otro") {
                $("#otro_text").show().attr("disabled",false);
            } else {
                $("#otro_text").hide().attr("disabled",true);
            }
        });
        $(function() {
